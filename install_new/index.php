...
<head>
    ...
    <link rel="shortcut icon" href="../webicon_uin.ico" type="image/x-icon" />
    <!-- Bootstrap CSS -->
...
<body>
    <div id="app" class="bg-gray-800 font-light">
        ...
        <account v-if="section === 'create-admin'" @notwrite="setSection('show-config', 'create-admin')" @success="section = 'success'"></account>
